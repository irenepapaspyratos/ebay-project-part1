...
class DateUtils {
    ...
    /**
     * The 'calculateNewTimestamp' method calculates a new timestamp by adding or subtracting a specified quantity 
     ...
     */
    public function calculateNewTimestamp(
        string $timestamp,
        string $operator,
        int $quantity,
        string $unit,
        ...
        // Create formatted timestamp, build interval and execute operation
